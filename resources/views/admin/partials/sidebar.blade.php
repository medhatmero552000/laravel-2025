		...
		<nav class="sidebar">
            ...
            <div class="sidebar-body">
              <ul class="nav">
                ...
                <x-singletab-component title="main" href="{{route('admin.index')}}" tabname="{{__('keywords.dashboard')}}" icon="grid"></x-singletab-component>
                ...
                <li class="nav-item">
                  ...
                  <div class="collapse" id="emails">
                    <ul class="nav sub-menu">
                      <li class="nav-item">
                        <a href="{{ route('admin.classrooms.index') }}" class="nav-link">{{__('keywords.add_new_classroom')}}</a>
                      </li>
